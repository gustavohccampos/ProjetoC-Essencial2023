...
Console.WriteLine($"/*Tipos por valor – Armazenam os dados diretamente " +
    $"onde cada variável tem a cópia dos dados e são\r\narmazenados na " +
    $"memória Stack\r\nTipos por referência – Não armazenam os dados " +
    $"diretamente e cada variável contém uma referência\r\nao local da " +
    $"memória onde os dados estão. São armazenados na memória Heap*/");
